...
.brand-logo.logo-hover .logo-img {
    transform:
        scale(1.18)
        rotate(-3deg);
...
.brand-logo.logo-hover .logo-ring {
    opacity: 1;
    ...
    box-shadow:
        ...
        inset 0 0 15px rgba(99, 102, 241, 0.10);
}


.brand-logo.logo-hover .brand-name {
    transform:
        translateX(2px);
...
.brand-logo.logo-hover .brand-motto {
    transform:
        translateX(3px);
